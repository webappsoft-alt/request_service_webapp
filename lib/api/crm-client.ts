...
/** Paginated customers list G현 supports `search` for the AG혀Z bar and search box. */
...
/** Paginated workforce list G현 MD: page/limit/active/role/trade/search only. */
...
/** Paginated contractors G현 MD: page/limit/trade/status/search only. */
...
/** Paginated vendors G현 MD: page/limit/category/status/search only. */
...
/** Paginated leads/requests G현 page/limit/search. */
...
/** Paginated estimates list G현 supports `status`, `customerId`, and `search`. */
...
/** Paginated jobs G현 page/limit/search. */
...
/** Paginated reminders G현 MD: page/limit/status/assignedEmployeeId/subjectKind/search only. */
...
/** Paginated invoices G현 page/limit/search. */
