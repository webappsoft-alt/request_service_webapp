  ...
  return (
    <div className="rounded-2xl bg-primary/[0.06] p-2.5 sm:p-3">
      <div className="overflow-hidden rounded-xl border border-input bg-card shadow-[0_18px_40px_-24px_rgba(0,63,125,0.4)]">
        <div className="flex items-center justify-between gap-3 border-b border-input px-3 py-2.5">
          <div>
        ...
        <div className="grid sm:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)]">
          <ul className="border-input sm:border-r">
            {rows.map((row) => (
              <li
                key={row.name}
                className={cn(
                  "flex items-start gap-2.5 border-b border-input px-3 py-2.5 last:border-b-0",
          ...
          <div className="flex flex-col gap-3 p-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="rounded-md border border-input px-2.5 py-1.5 text-[11px] text-muted-foreground">
                Later
              </span>
            </div>
          </div>
    ...
    <div className="rounded-2xl bg-primary/[0.06] p-2.5 sm:p-3">
      <div className="overflow-hidden rounded-xl border border-input bg-card shadow-[0_18px_40px_-24px_rgba(0,63,125,0.4)]">
        ...
        <div className="grid gap-0 sm:grid-cols-[minmax(0,1.15fr)_minmax(0,0.85fr)]">
          <div className="border-input px-3 py-3 sm:border-r">
...
const scheduleToneClass: Record<ScheduleTone, string> = {
  ...
  slate: "border border-dashed border-input bg-[#EEF2F6] text-muted-foreground",
};
...
function SchedulePanel() {
  ...
  return (
    <div className="rounded-2xl bg-primary/[0.06] p-2.5 sm:p-3">
      <div className="overflow-hidden rounded-xl border border-input bg-card shadow-[0_18px_40px_-24px_rgba(0,63,125,0.4)]">
        <div className="flex flex-wrap items-center justify-between gap-2 border-b border-input px-3 py-2.5">
          <div className="flex items-center gap-1.5">
            <span className="rounded-md border border-input px-2 py-1 text-[11px] font-medium">
              Today
            </span>
        ...
        <div className="overflow-x-auto">
          <div className="min-w-[34rem]">
            <div className="grid grid-cols-[8.75rem_minmax(0,1fr)] border-b border-input">
              ...
              <div className="grid grid-cols-7">
                {hours.map((hour) => (
                  <div
                    key={hour}
                    className="border-l border-input px-1 py-2 text-center text-[10px] font-medium text-muted-foreground"
                  >
                    {formatHour(hour)}
                  </div>
                ))}
            ...
            {techs.map((tech) => (
              <div
                key={tech.id}
                className="grid grid-cols-[8.75rem_minmax(0,1fr)] border-b border-input last:border-b-0"
              >
                <div className="flex items-center gap-2 px-3 py-2.5">
                  {tech.photo ? (
                    ...
                    <span className="size-8 shrink-0 rounded-full border border-dashed border-input bg-[#F4F7FA]" />
                  )}
                ...
                <div className="relative min-h-[3.65rem]">
                  <div className="absolute inset-0 grid grid-cols-7">
                    {hours.map((hour) => (
                      <div key={hour} className="border-l border-input" />
                    ))}
                  </div>
                  {tech.jobs.map((job) => (
                    <div
